...
;; it started with and all callee-saved registers in the same state they
;; started in.
...
;; The sequence should leave the stack with rax fewer elements than they
;; started with and all callee-saved registers in the same state they
;; started in.
