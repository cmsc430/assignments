...
(define (test run)
  ...
  (begin ;; Loot with Bignums
    (check-equal? (run '(= 18446744073709551616 18446744073709551616)) #t)
    (check-equal? (run '(= 1809251394333065553493296640760748560207343510400633813116524750123642650624
                           (add1 1809251394333065553493296640760748560207343510400633813116524750123642650623)))
                  #t)
    (check-equal? (run '(= 1809251394333065553493296640760748560207343510400633813116524750123642650624
                           (add1 1809251394333065553493296640760748560207343510400633813116524750123642650624)))
                  #f)
    (check-equal? (run '(zero? 513943330655534932966407607485602073435104006338131165247))
                  #f)
    (check-equal? (run '(= (+ 513943330655534932966407607485602073435104006338131165247 100)
                           513943330655534932966407607485602073435104006338131165347))
                  #t)
    (check-equal? (run '(= (+ 513943330655534932966407607485602073435104006338131165247
                              1606938044258990275541962092341162602522202993782792835301376)
                           1607451987589645810474928499948648204595638097789130966466623))
                  #t)
    (check-equal? (run '(+ 513943330655534932966407607485602073435104006338131165247
                           -513943330655534932966407607485602073435104006338131165247))
                  0)
    (check-equal? (run '(- 513943330655534932966407607485602073435104006338131165247
                           513943330655534932966407607485602073435104006338131165248))
                  -1)))
